...
from ...utils.reward_score import math_compute_score, r1v_compute_score, ts_compute_score
...
class CustomRewardManager:
    def __init__(self, tokenizer: PreTrainedTokenizer, config: RewardConfig):
        ...
        elif config.score_function == "ts":
            self.compute_score: Callable[[str, str], RewardScore] = ts_compute_score
        else:
